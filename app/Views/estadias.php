...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formAgregarEstadia" action="<?= base_url('agregar_estadia'); ?>" method="post">
                        ...
                        <label for="txt_marbete" class="form-label mt-2">Marbete</label>
                        <input type="number" name="txt_marbete" id="txt_marbete" class="form-control">
    ...
    <script>
        ...
        form.addEventListener("submit", function(e) {
            ...
            let marbete = document.getElementById("txt_marbete").value.trim();

            if (tarifa === "" || entrada === "" || salida === "" || costo === "" || marbete === "") {
                Swal.fire({
                    title: "Campos vacíos",
